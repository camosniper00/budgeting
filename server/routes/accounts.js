...
router.post('/', (req, res) => {
  ...
  db.prepare('INSERT INTO accounts (id, user_id, name, type, balance, institution, account_number_last4) VALUES (?, ?, ?, ?, ?, ?, ?)')
    .run(id, req.userId, name, type, balance || 0, institution, account_number_last4);
...
router.put('/:id', (req, res) => {
  ...
  db.prepare(`UPDATE accounts SET
    ...
    .run(name, type, balance, institution, account_number_last4, is_active, req.params.id, req.userId);
